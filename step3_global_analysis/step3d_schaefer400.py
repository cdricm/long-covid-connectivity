...
# Sweep metrics: confirmatory strategy, read from the _cross_strategy tree
...
# Confirmatory Family-A output belongs in the confirmatory strategy tree
# (consistent with step3d_a; partial-arm-safe).
...
def main():
    assert STRATEGY is not None, (
        "CONFIRMATORY_SIGN_STRATEGY is None — set the confirmatory strategy "
        "(Pearson: 'positive' via FC_METHOD; partial: after the 3a/3b/3c diagnostic) "
        "before running Family A inference."
    )
