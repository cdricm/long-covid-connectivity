"""
Step 3a threshold-sweep diagnostic for Schaefer-400, all three sign strategies,
group-blind.

In: cached matrices via config.atlas_dir("schaefer400", "step2_pipeline"),
    config.GROUP_CSV.
Out: config.atlas_dir("schaefer400", "step3a_sweep", cross_strategy=True)/
...
run_threshold_sweep(
    paths_cfg = {
        ...
        "out_dir"     : config.atlas_dir("schaefer400", "step3a_sweep", cross_strategy=True),
