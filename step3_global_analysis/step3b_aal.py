"""
Step 3b disconnect diagnostic for AAL, all three sign strategies (group-blind),
one subfolder per strategy under the _cross_strategy tree.

In: cached matrices via config.atlas_dir("aal", "step2_pipeline"),
    config.GROUP_CSV.
Out: config.atlas_dir("aal", "step3b_diagnose/<strategy>",
