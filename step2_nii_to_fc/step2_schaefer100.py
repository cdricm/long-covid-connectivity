"""Step 2 for Schaefer-100 (7 networks, 2mm).
...
def main():
    run_pipeline(
        atlas_cfg = {
            ...
            "yeo_networks"  : 7,
            "resolution_mm" : 2,
            "label"         : "Schaefer-100 (7 networks)",
        },
        paths_cfg = {
            "nii_root"    : config.NII_ROOT,
            "out_mat_dir" : config.atlas_dir("schaefer100", "step2_pipeline") / "comet_matrices",
            "out_ts_dir"  : config.atlas_dir("schaefer100", "step2_pipeline") / "comet_timeseries",
            "out_log_dir" : config.atlas_dir("schaefer100", "step2_pipeline"),
        },
        processing_cfg = {
            "n_jobs"            : 2,
            "use_cache"         : True,
